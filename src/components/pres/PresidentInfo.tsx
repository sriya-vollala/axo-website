function PresInfo() {
    return (
        ...
        <><p className = 'pres-note'>Hiiii! My name is Alexa and I’m a second-year Biology major on the pre-med track. 
            ...
            It’s an experience I wouldn’t get anywhere else, and I’m so grateful to Alpha Chi for giving me that opportunity.
            </p>
            <p className='pres-note'> </p>

            <p className = 'pres-note'>Getting involved in our chapter has helped me build deeper connections not just within Alpha Chi,
